...
public class StaffDB extends DBFacade {
    ...
    public void createStaffMember(String staff_FName, String staff_LName, String staff_PhoneNo, String staff_Mail, Date staff_StarteDate, String staff_Address, int city_Zip, String jobtitle_Occupation) throws SQLException {
